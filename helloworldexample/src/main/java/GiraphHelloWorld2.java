...
public class GiraphHelloWorld2 extends BasicComputation<IntWritable, IntWritable, NullWritable, NullWritable> {

  @Override
  public void compute(Vertex<IntWritable, IntWritable, NullWritable> vertex, Iterable<NullWritable> messages) {
    System.out.println("22222 Hello world from the: " + vertex.getId().toString() + " who is following:");
